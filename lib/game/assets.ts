...
export const ASSETS: Asset[] = [
  ...
  { id: "StaticDust", name: "Static Dust", type: "effect", rarity: "common", description: "【静的 / Static】微細なノイズ。 / Fixed subtle noise.", unlocked: true },
  { id: "Vignette", name: "Soft Vignette", type: "effect", rarity: "common", description: "【静的 / Static】四隅を暗く落とす影。 / Darkened corners.", unlocked: true },
  { id: "LightLeak", name: "Light Leak", type: "effect", rarity: "common", description: "微かな光の漏れ。 / Subtle light leak.", unlocked: true },
  { id: "Sparkle", name: "Fairy Dust", type: "effect", rarity: "rare", description: "【動的要素 1 / Active: 1】幻想的に煌めく小さな光。 / Small, phantom sparkles.", unlocked: false },
  ...
  { id: "Bubbles", name: "Champagne Bubbles", type: "effect", rarity: "rare", description: "【動的要素 1 / Active: 1】華やかに立ち昇る気泡。 / Elegant rising bubbles.", unlocked: false },
  ...
  { id: "Scanline", name: "CRT Scanline", type: "effect", rarity: "epic", description: "【動的要素 3 / Active: 3】レトロフューチャーな走査線とグリッド。 / Retro-future scanlines and grid.", unlocked: false },
  ...
  { id: "DigitalRain", name: "Matrix Rain", type: "effect", rarity: "epic", description: "【動的要素 3 / Active: 3】落下するコードの雨とグリッチ。 / Falling code sequence and glitch.", unlocked: false },
  ...
  { id: "Singularity", name: "Singularity", type: "effect", rarity: "mythic", description: "【動的要素 5 / Active: 5】中心へと収束する時空の歪み。 / Space-time distortion converging to the center.", unlocked: false },
  ...
  { id: "RealityTear", name: "Reality Tear", type: "effect", rarity: "mythic", description: "【動的要素 5 / Active: 5】空間の裂け目と激しいスパーク。 / A tear in space-time with intense sparks.", unlocked: false },
  { id: "Halo", name: "Celestial Halo", type: "effect", rarity: "mythic", description: "降り注ぐ天光。 / Descending celestial light.", unlocked: false },
  { id: "CherryPetals", name: "Cherry Petals", type: "effect", rarity: "legendary", description: "【動的要素 4 / Active: 4】幻想的なピンクの花弁が舞い落ちる。 / Ethereal pink petals drifting in the wind.", unlocked: false },
  { id: "BinaryCascade", name: "Binary Cascade", type: "effect", rarity: "legendary", description: "【動的要素 4 / Active: 4】仮想空間から降り注ぐ微細なデータコード。 / Subtle binary data streams cascading down.", unlocked: false },
