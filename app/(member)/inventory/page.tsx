...
export default function InventoryPage() {
  ...
  const [assets, setAssets] = useState<Asset[]>([
    ...
    { id: "Dynamic", name: "Azure Pulse", type: "frame", rarity: "legendary", description: "知性を感じさせる蒼い脈動。", cost: 15000, unlocked: false },
    { id: "Crimson", name: "Crimson Guard", type: "frame", rarity: "legendary", description: "情熱的な深紅の防壁。", cost: 15000, unlocked: false },
    ...
    { id: "Nebula", name: "Cosmic Nebula", type: "background", rarity: "legendary", description: "静かなる宇宙の階調。", cost: 15000, unlocked: false },
    { id: "SilkBlur", name: "Silk Blur", type: "background", rarity: "legendary", description: "滑らかな光の拡散。", cost: 15000, unlocked: false },
    ...
    { id: "Interference", name: "Signal Interference", type: "effect", rarity: "legendary", description: "静かな波紋の干渉。", cost: 15000, unlocked: false },
    { id: "Dust", name: "Cosmic Dust", type: "effect", rarity: "legendary", description: "漂う宇宙の塵。", cost: 15000, unlocked: false },
    ...
    { id: "Crimson Trace", name: "Crimson Ember", type: "pointer", rarity: "legendary", description: "消えない残り火の軌跡。", cost: 15000, unlocked: false },
    { id: "Shadow Trace", name: "Ink Shadow", type: "pointer", rarity: "legendary", description: "空間を塗りつぶす墨の軌跡。", cost: 15000, unlocked: false },
    ...
    { id: "deep", name: "Deep Impact", type: "sound", rarity: "legendary", description: "腹に響く重厚な低音。", cost: 15000, unlocked: false },
    { id: "heaven", name: "Angelic Choir", type: "sound", rarity: "legendary", description: "天界の歌声の一節。", cost: 15000, unlocked: false },
    ...
    { id: "Headhunter", name: "Headhunter", type: "title", rarity: "legendary", description: "重役層との共鳴。", cost: 15000, unlocked: false },
    { id: "Gilded Soul", name: "Gilded Soul", type: "title", rarity: "legendary", description: "富の象徴。", cost: 15000, unlocked: false },
