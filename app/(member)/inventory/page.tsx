...
export default function InventoryPage() {
  ...
  const [assets, setAssets] = useState<Asset[]>([
    ...
    { id: "VOID VOYAGER", name: "VOID VOYAGER", type: "title", rarity: "rare", description: "実績：100回以上の接続を記録した証。", unlocked: true },
    { id: "HEADHUNTER", name: "HEADHUNTER", type: "title", rarity: "epic", description: "実績：経営層の魂を10人以上アーカイブした証。", unlocked: false },
                    ...
                    >
                      ...
                      <div className="text-right">
                        {asset.unlocked ? (
                           ...
                           <Wallet size={12} className="text-bronze-400 opacity-40" />
                        )}
                      </div>
                    </div>
                  ))}
