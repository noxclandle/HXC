  ...
  return (
    <div className="max-w-md w-full space-y-12">
      ...
      <div className="space-y-4">
        <h1 className="text-2xl tracking-[0.5em] uppercase font-light text-white">注文完了 / Order Complete</h1>
        <p className="text-[10px] tracking-widest text-azure-400 opacity-60 uppercase">決済が正常に完了しました / Payment Completed Successfully</p>
      </div>

      <div className="p-8 border border-white/5 bg-white/[0.02] text-left space-y-6">
         <div className="space-y-1">
            <span className="text-[8px] uppercase tracking-widest opacity-30">取引ID / Transaction ID</span>
         ...
         <p className="text-[11px] leading-relaxed tracking-widest text-white/40 uppercase">
            ご注文いただいた物理カードの製造・登録準備を開始しました。<br />
            発送が完了するまで、今しばらくお待ちください。<br />
            カードがお手元に届きましたら、スマートフォンにかざして初期設定を行ってください。 / Physical card manufacturing has started. Once received, scan with your smartphone to configure your profile.
         </p>
      </div>
      ...
      <div className="flex flex-col gap-4">
         ...
         >
           ホームに戻る / Return to Home <ArrowRight size={14} />
         </Link>
         <Link 
           href="/contact"
         ...
         >
           お問い合わせ / Contact Support <ArrowRight size={14} />
         </Link>
...
export default function PurchaseSuccessPage() {
  return (
    <main className="min-h-screen bg-void flex flex-col items-center justify-center p-6 text-center">
      <Suspense fallback={<div className="text-white opacity-20 uppercase tracking-widest text-[10px]">処理中... / Processing...</div>}>
        <SuccessContent />
      </Suspense>
    </main>
  );
