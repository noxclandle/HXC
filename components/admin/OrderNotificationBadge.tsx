...
export default function OrderNotificationBadge() {
  ...
  if (count === 0) {
    return (
      <Link href="/admin/ledger" className="hover:text-azure-400 hover:opacity-100 transition-colors flex items-center gap-2">
  ...
  return (
    <Link href="/admin/ledger" className="text-azure-400 hover:text-azure-300 transition-colors flex items-center gap-2 font-bold relative group">
